...
date: '`r fontawesome::fa("twitter")` [\@HeathrTurnr](https://twitter.com/heathrturnr)<br><br>4 May 2022<br><br><span style="font-size:50px;font-weight:600";>`r fontawesome::fa("link")` [heatherturner.net/talks/DiveRSE2022](heatherturner.net/talks/DiveRSE2022)</span>'
output:
...
`r fontawesome::fa("link")` [heatherturner.net/talks/DiveRSE2022](heatherturner.net/talks/DiveRSE2022)</span>
]
.pull-right-45[
<br>
<br>
...
.pull-right[
<img src="rcore.png" alt="" style="width:550px">
] 
