...
# useR! Incubator Session

.pull-left[

The useR! conference introduced "incubators" for 2021

> give the opportunity to people working in similar fields to connect and work on a common goal or question.
...
.pull-right[
[![Title slide from useR! 2021 keynote: Research Software Engineers (& Academia) by Heidi Seibold, affiliated to the Johner Institut and IGDORE](Heidi_Seibold_useR2021_keynote_title_slide.png)](https://youtu.be/Xhwh80aTF0k)
![R and RSE logos with a heart in between](R_heart_RSE.png)
Image credits: @HeidiBaya
]
...
*  Ania Brown (RSE at the University of Southampton, UK and Trustee at the Society of Research Software Engineering) 
   - Gave introductory talk
* Mario Antonioletti (RSE at Software Sustainability Institute, UK).
   - Helped plan and facilitate
]

.pull-right[
<a href="https://www.youtube.com/watch?v=Xhwh80aTF0k"><img src="RSE_incubator_intro_title.jpg" width=550>Ania Brown's talk "Society of Research Software Engineering" on YouTube.</a>
]
...
- Created \#r-users groups on RSESlack
- Published post about incubator on useR! blog
- Presented this talk!
